...
describe("Users", () => {
  ...
  describe("can be created", () => {
    it("with no errors", done => {
      const changePasswordStub = sinon
        .stub(User.prototype, "changePassword")
        .resolves(fred);
  ...
  describe("can be authenticated", () => {
    ...
    it("without errors", done => {
      ...
      User.authenticate(fred.username, UserFactory.fredData.password).then(
        user => {
  ...
  describe("can manage notifications", () => {
    it("by successfully marking notifications as seen", done => {
      ...
      const markSeenStub = sinon
        .stub(Notification.prototype, "markSeen")
        .resolves(NotificationFactory.seenNotification());
